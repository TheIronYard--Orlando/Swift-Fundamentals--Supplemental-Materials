...
//: The [Swift programming language](https://developer.apple.com/swift/) was built by Apple in-house over the course of about 4 years. It was designed to be a modern replacement for their previous language-of-choice, Objective-C. You'll learn about Objective-C as well, but let's not get ahead of ourselves.
...
//: Swift is known as a _strongly-typed_ language, meaning that the compiler will not allow data types that are different from being converted automatically. This is generally referred to as _type safety_. To illustrate, see the example below:
var life = 42
